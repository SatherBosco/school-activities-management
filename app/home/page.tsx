...
import flatlay from "../../assets/img/flat-lay-laptop-blue-background1.png";
    ...
    <header className={styles.cabecalho}>
        <nav className={styles.cabecalhoMenu}>
            <div className={styles.cabecalhoMenuImagem}>
                <Image className={styles.cabecalhoMenuImagem1} src={graphics} alt="Logo1"/>
                <Image className={styles.cabecalhoMenuImagem2} src={Group2} alt="Logo2"/>
            </div>
