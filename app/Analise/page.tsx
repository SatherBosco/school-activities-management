    ...
    <header className={styles.cabecalho}>
        <nav className={styles.cabecalhoMenu}>
            ...
            <div className={styles.cabecalhoMenuLinks}>
                <a className={styles.cabecalhoMenuLinks1} href="../app/Analise_Grafico/page.tsx">Análise - Graficos</a>
                <Image className={styles.cabecalhoMenuLinksBarra1} src={Rectangle4} alt="Barra de separação"/>
                <a className={styles.cabecalhoMenuLinks2} href="../app/Analise_Tabela/page.tsx">Análise - Tabelas</a>
            </div>
            <div>
